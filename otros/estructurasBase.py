...
# En este caso, resultado suma almacena el resultado de
# sumar variable_entera y variable_decimal y comparación
...
# Estructuras de Control de desiciones.
...
try:
    ...
    print("Bloque 'finally': Este código se ejecuta suempre, haya o no haya errores.")

# Trabajo con archivos
with open("archivo.txt", "w") as archivo:
    archivo.write("¡Hola desde un archivo!")

# Módilos y Bibliotecas
import math
...
lingitud_cadena = len("Python")
masyusculas     = "hola".upper()
minusculas      = "HOLA".lower()
reemplazo       = "python es divertido".replace("divertido", "increible")